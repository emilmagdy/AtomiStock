...
export const addStockBatchController = async (req: Request, res: Response) => {
...
export const deleteStockBatchController = async (req: Request, res: Response) => {
...
export const getALLStockBatchesController = async (req: Request, res: Response) => {
...
export const getStockBatchesForProductController = async (req: Request, res: Response) => {
